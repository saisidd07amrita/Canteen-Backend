...
MONGO_URI = "mongodb+srv://sai_siddhu07:kbPb7FPEtn9Lc98n@cluster0.9yjva.mongodb.net/?retryWrites=true&w=majority&tls=true"

client = MongoClient(MONGO_URI, tls=True, tlsAllowInvalidCertificates=True)  # ✅ Ensures TLS 1.2+
db = client["canteen"]
